...
The repo ships a 50-line conversion script at [`examples/migrate-from-sehawq-v5/`](https://github.com/nookwright/nookdb/tree/main/examples/migrate-from-sehawq-v5). It expects a v5 JSON export with the most common shape:
